 ...
 * @author ehsan
 */
public class British_Traffic_Light extends javax.swing.JFrame {
    ...
    public British_Traffic_Light() {
        ...
        taskGreen2Yellow.setNextTask(taskYellow2Red, 2000);
        taskYellow2Red.setNextTask(taskRed2Red, 2000);
        taskRed2Red.setNextTask(taskRed2Green, 1000);
        taskRed2Green.setNextTask(taskGreen2Yellow, 4000);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(British_Traffic_Light.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new British_Traffic_Light().setVisible(true);
            }
        });
    }
